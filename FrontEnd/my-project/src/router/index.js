...
const routes = [
  { path: '/', name: 'HotelOne', component: HotelOne, meta: { title: '메인' } },
  { path: '/hotel', name: 'HotelTwo', component: HotelTwo, meta: { title: '호텔' } },
  { path: '/room', name: 'HotelThree', component: HotelThree, meta: { title: '객실' } },
  { path: '/payment', name: 'HotelFour', component: HotelFour, meta: { title: '결제' } },
...
async function checkTokenValidity(token) {
  try {
    const apiUrl = process.env.VUE_APP_API_URL || 'http://mjc813k.softagape.com/'
