        ...
        <main class="main-content">
          <section class="results-section">
            <div class="hotel-cards" :class="{ 'show-all': showingAll }">
              ...
              <!-- 기본 호텔 카드들 -->
              <div class="hotel-card" v-for="(hotel, index) in visibleHotels" :key="hotel.id">
                ...
                <div class="hotel-content">
                  ...
                  <div class="price-info">
                    ...
                    <div class="price-amount">₩{{ hotel.price.toLocaleString() }}<span class="price-unit">/night</span></div>
                  ...
                  <div class="hotel-meta">
                    ...
                    <span class="hotel-type">{{ hotel.starRating }} Star Hotel</span>
                    <span class="amenities">
                      <img src="@/assets/hotel_img/coffee.jpg" alt="coffee"/> 
                  ...
                  <div class="bottom-section">
                    <div class="button-container">
                      <button 
                        ...
                        :style="{ color: hotel.isWished ? '#FF6B6B' : '#666666' }"
                      >
                        {{ hotel.isWished ? '♥' : '♡' }}
                      </button>
    ...
    <section class="newsletter-section">
      ...
      <div class="footer-content">
        <div class="social-icons">
          <img src="@/assets/hotel_img/facebook.jpg" alt="facebook"/>
          <img src="@/assets/hotel_img/twitter.jpg" alt="twitter"/>
          <img src="@/assets/hotel_img/youtube.jpg" alt="youtube"/>
          <img src="@/assets/hotel_img/instagram.jpg" alt="instagram"/>
        </div>
...
export default {
      ...
      hotels: [
        {
          id: 1,
          name: '해튼호텔',
          image: '@/assets/hotel_img/hotel1.jpg',
          imageCount: 9,
          price: 240000,
        ...
        },
        {
          id: 2,
          name: '마제스틱 말라카 호텔',
          image: '@/assets/hotel_img/hotel2.jpg',
          imageCount: 9,
          price: 120000,
        ...
        },
        {
          id: 3,
          name: '카나휘 리모 호텔',
          image: '@/assets/hotel_img/hotel3.jpg',
          imageCount: 9,
          price: 130000,
          location: 'Kuçukayasofya No. 40 Sultanahmet, Istanbul 34022',
          stars: '★★★★★',
        ...
        },
        {
          id: 4,
          name: '베이알 호텔',
          image: '@/assets/hotel_img/hotel4.jpg',
          imageCount: 9,
          price: 104000,
          location: 'Kuçukayasofya No. 40 Sultanahmet, Istanbul 34022',
          stars: '★★★★★',
  ...
  computed: {
    visibleHotels() {
      return this.showingAll ? this.hotels : this.hotels.slice(0, 3)
    }
  },
  mounted() {
  ...
  methods: {
    ...
    toggleWishlist(index) {
      this.hotels[index].isWished = !this.hotels[index].isWished
    },
    subscribe() {
      if (this.email) {
